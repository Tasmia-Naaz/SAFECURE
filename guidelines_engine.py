...
class GuidelineEngine:
    ...
    # EXPANDED TREATMENT KEYWORDS - NOW INCLUDES ALL TREATMENTS
    TREATMENT_KEYWORDS = [
        # Standard treatments
        ...
        'combination therapy', 'combined treatment', 'multimodal therapy',
        ...
        'embolization', 'chemoembolization', 'tace',
        'radioactive therapy', 'radioisotope therapy'
    ]
    ...
    def format_stage_display(self, stage):
        """Format stage for display (fixes 'Stage Ii' to 'Stage II')"""
        stage_mappings = {
            'stage_0': 'Stage 0',
            'stage_i': 'Stage I',
            'stage_ii': 'Stage II',
...
• Combination therapy / Multimodal therapy
